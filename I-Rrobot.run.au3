...
#pragma compile(Icon, "Icons\archer.ico")
#pragma compile(FileDescription, Clash of Clans Bot - A Free Clash of Clans bot)
#pragma compile(ProductName, I, ROBOT)

#pragma compile(ProductVersion, 1.0)
#pragma compile(FileVersion, 1.0.0)
#pragma compile(LegalCopyright, © fredelec)
...
$sBotVersion = "v0.99 beta" ;~ Don't add more here, but below. Version can't be longer than vX.y.z because it it also use on Checkversion()
$sBotTitle = "I, ROBOT " & $sBotVersion & " " & $DEFAULT_WIDTH & "x" & $DEFAULT_HEIGHT & " "
...
CheckVersion() ; check latest version on fredelec site
