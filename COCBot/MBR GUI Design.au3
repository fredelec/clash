...
Local $x = 30, $y = 150
	$grpCredits = GUICtrlCreateGroup("Credits", $x - 20, $y - 20, 450, 375)
		$txtCredits = "I, ROBOT is brought to you by a litle team of people who actually are "  & @CRLF & _
						"living in Puntillo's House of Terror where everything is goind down!"
		$lblCredits1 = GUICtrlCreateLabel($txtCredits, $x - 5, $y, 400, 50)
			GUICtrlSetFont(-1, 9, $FW_BOLD)
			GUICtrlSetColor(-1, $COLOR_NAVY)
		$y += 60
		$txtCredits = "Please visit our web site:"
		$lblCredits2 = GUICtrlCreateLabel($txtCredits, $x - 5, $y, -1, -1)
		$y += 20
		$labelMyBotURL = GUICtrlCreateLabel("https://puntillo.vouyer.xxx", $x - 5, $y, 150, 20)
			GUICtrlSetFont(-1, 8.5, $FW_BOLD)
			GUICtrlSetColor(-1, $COLOR_BLUE)
		$y += 25
		$lblCredits3 = GUICtrlCreateLabel("Credits go to the following Clash of Clans players for donating their time: ", $x - 5, $y , 400, 35)
			GUICtrlSetFont(-1, 8.5, $FW_BOLD)
		$y += 40
		$txtCredits =	"Magico who is researching for 'never want to lose' specially at RISICO board game. "& @CRLF & _
						"Drusylla the 'avevA' italian teacher."  & @CRLF & _
                        "Mimi who is on hibernation state because she always sleep."  & @CRLF & _
						"Fredelec il cacone. " & @CRLF & @CRLF
